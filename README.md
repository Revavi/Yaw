...
## Как установить (V1.2+)
  ...
  2. В файле config.json пропишите токен заранее созданного телеграмм бота и ваш UID
    _Для v1.3+ вы можете прописать секретный пароль для выдачи доступа к боту на другие аккаунты в переменной "password", или же оставить поле пустым, тогда доступ будете иметь только вы._
    _Пароль всегда можно создать/удалить/изменить при помощи команд._
